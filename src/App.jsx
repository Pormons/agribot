      ...
      try {
        ...
        if (gen) {
          ...
          const result = await client.predict("/model_chat", {
            query: input,
            history: [],
            system: `You are a friendly Farmer Chatbot named Mang Juan based in the Philippines, Who Speaks ${language}, Youre only knowledge is about Farming, all query that are not related to farming will be ignored, all replies should be friendly and not sarcastic`,
          });
